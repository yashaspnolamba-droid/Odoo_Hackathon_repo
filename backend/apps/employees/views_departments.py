...
class DepartmentViewSet(OrganizationScopedQuerySetMixin, viewsets.ModelViewSet):
    """Department CRUD — read for org members, write for HR/Admin."""

    queryset = Department.objects.select_related("organization", "manager__user").all()

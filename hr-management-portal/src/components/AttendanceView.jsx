            ...
            <tbody>
              {attendanceRecords.map(log => (
                <tr key={log.id}>
                  ...
                  <td>{log.working_hours ? `${log.working_hours}h` : 'In Progress'}</td>
                  <td>

...
import { LayoutDashboard, User, Clock, Calendar, CheckSquare, DollarSign, ShieldAlert, Users, LogOut, Shield } from 'lucide-react';
...
export const Sidebar = () => {
  ...
  // Base Menu for Employee
  const employeeItems = [
    { id: 'dashboard', label: 'Dashboard', icon: LayoutDashboard },
    { id: 'profile', label: 'My Profile', icon: User },
    { id: 'attendance', label: 'Attendance', icon: Clock },
    { id: 'apply-leave', label: 'Apply for Leave', icon: Calendar },
    { id: 'employee-payroll', label: ' Employee Payroll', icon: DollarSign },
  ];

  // Additional Menu Items for HR/Admin
  const hrItems = [
    { id: 'dashboard', label: 'HR Dashboard', icon: LayoutDashboard },
    { id: 'leave-approval', label: 'Leave Approval', icon: CheckSquare },
    { id: 'admin-payroll', label: 'Admin Payroll', icon: ShieldAlert },
    { id: 'directory', label: 'Employee Directory', icon: Users },
    { id: 'profile', label: 'My Profile', icon: User },
    { id: 'attendance', label: 'Attendance', icon: Clock },
  ];

  const menuItems = isHR ? hrItems : employeeItems;
    ...
    <aside className="sidebar">
      <div style={{ padding: '0.5rem 0.5rem 1rem', borderBottom: '1px solid #1e293b', marginBottom: '1rem' }}>
        <span style={{ fontSize: '0.7rem', textTransform: 'uppercase', letterSpacing: '0.08em', color: '#64748b', fontWeight: 700 }}>
          {isHR ? 'HR Admin Management' : 'Employee Portal'}
        </span>
      </div>
